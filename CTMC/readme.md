This file contains codes to implement the continuous-time Markov chain model for different layour configurations under full and partial access controls. 
